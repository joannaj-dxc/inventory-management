export default {
  ...
  restocking: {
    title: "Restocking",
    description:
      "Get budget-based restocking recommendations from demand forecasts",
    budget: {
    ...
    orderSuccess:
      "Order {orderNumber} submitted successfully! View it in the Submitted Orders section of the Orders tab.",
    orderError: "Failed to submit restocking order. Please try again.",
    noRecommendations:
      "No items can be recommended for this budget. Try increasing the budget.",
  },
