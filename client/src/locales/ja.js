export default {
  ...
  restocking: {
    ...
    currentQty: "現在の数量",
    forecastedQty: "予測需要量",
    recommendedQty: "推奨補充量",
    totalCost: "合計費用",
    priority: "優先度",
    noRecommendations: "推奨事項が見つかりません。予算を増やしてみてください。",
    selectItemsError: "注文する商品を少なくとも1つ選択してください。",
    orderSummary: "注文概要",
    selectedItems: "選択商品",
    orderTotal: "注文合計",
    placeOrder: "注文を確定",
    submitting: "送信中...",
    orderSuccess: "注文が正常に確定されました！注文番号:",
    placeAnotherOrder: "別の注文を確定",
    errorLoadingRecommendations: "推奨事項の読み込みエラー",
    errorPlacingOrder: "注文確定エラー",
  },
